...
>
> 🤖 **Automated builds:** pushing a `v*` tag runs GitHub Actions
> (`.github/workflows/build.yml`) that build the Android debug APK and the
> Linux / Windows / macOS desktop installers and attach them to the matching
> release — no manual build step needed.
